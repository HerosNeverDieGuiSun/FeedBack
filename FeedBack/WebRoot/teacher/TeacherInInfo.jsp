      ...
      <section class="wrapper">
        ...
        <div class="row mt">
          ...
          <div class="col-lg-12">
            ...
            <jsp:useBean id="teacherin" scope="request" class="com.feedback.domain.TeacherIn" />
             <form:form modelAttribute="teacherin" action="#" class="form-horizontal style-form" method="POST">
              <div class="form-group">
                  <label class="control-label col-md-3">教工号</label>
                  <div class="col-md-3 col-xs-11">
                    <form:input path="tino" class="form-control" readonly="true"/>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <form:input path="tipsw" class="form-control" readonly="true"/>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <form:input path="tiname" class="form-control" readonly="true"/>
                  </div>
                </div>
                
				<div class="form-group">
                  <label class="control-label col-md-3">ico</label>
                  <div class="col-md-3 col-xs-11">
                    <form:input path="ico" class="form-control" readonly="true"/>
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <form:input path="tiprofession" class="form-control" readonly="true"/>
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <form:input path="tischolar" class="form-control" readonly="true"/>
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <form:input path="ticome" class="form-control" readonly="true"/>
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <form:input path="tischool" class="form-control" readonly="true"/>
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <form:textarea path="tioversea" class="form-control" readonly ="true" />
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <form:textarea path="tibackground" class="form-control" readonly ="true" />
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                   <form:textarea path="tiwork" class="form-control" readonly ="true" />
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <form:textarea path="tiscpaper" class="form-control" readonly ="true" />
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <form:textarea path="titeapaper" class="form-control" readonly ="true" />
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <form:textarea path="tipatent" class="form-control" readonly ="true" />
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <form:textarea path="tisoft" class="form-control" readonly ="true" />
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <form:textarea path="tisp" class="form-control" readonly ="true" />
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <form:textarea path="tiprize" class="form-control" readonly ="true" />
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <form:textarea path="tireward" class="form-control" readonly ="true" />
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <form:textarea path="tiarch" class="form-control" readonly ="true" />
                  </div>
                </div>
