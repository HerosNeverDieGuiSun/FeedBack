...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<%=path%>/leader/lib/bootstrap-fileupload/bootstrap-fileupload.css" />
  <link rel="stylesheet" type="text/css" href="<%=path%>/leader/lib/bootstrap-datepicker/css/datepicker.css" />
  <link rel="stylesheet" type="text/css" href="<%=path%>/leader/lib/bootstrap-daterangepicker/daterangepicker.css" />
  <link rel="stylesheet" type="text/css" href="<%=path%>/leader/lib/bootstrap-timepicker/compiled/timepicker.css" />
  <link rel="stylesheet" type="text/css" href="<%=path%>/leader/lib/bootstrap-datetimepicker/datertimepicker.css" />
            ...
            <section class="panel">
              ...
              <div class="panel-body ">
                ...
                <div class="compose-btn pull-left">
                  <button class="btn btn-sm "><i class="fa fa-arrow-right"></i><a href="./LeaderSendTeacherCtrl" >发给老师</a></button>
                  <button class="btn btn-sm "><i class="fa fa-arrow-right"></i><a href="./LeaderAgreeCtrl" > 同意</a></button>
                  <button class="btn btn-sm "><i class="fa fa-arrow-right"></i><a href="./LeaderDisagreeCtrl" > 不同意</a></button>
